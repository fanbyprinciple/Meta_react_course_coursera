        ...
        >
          {groupedHistory.map(([date, Items]) => (
            <View key={date} style={styles.dateGroup}>
              ...
              {Items.map((Effort) => (
                <View key={Effort.id} style={styles.historyCard}>
                  <View
                    style={[
                      styles.taskColor,
                      { backgroundColor: Effort.task?.color || "#ccc" },
                    ]}
                  />
                  <View style={styles.taskInfo}>
                    <Text style={styles.taskName}>
                      {Effort.task?.name || "Unknown task"}
                    </Text>
                    <Text style={styles.taskmanhour}>
                      {Effort.task?.manhour}
                    </Text>
                    <Text style={styles.timeText}>
                      {new Date(Effort.timestamp).toLocaleTimeString("default", {
                        hour: "2-digit",
                        minute: "2-digit",
                      })}
                    </Text>
